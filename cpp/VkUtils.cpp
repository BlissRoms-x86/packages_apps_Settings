...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_android_settings_deviceinfo_firmwareversion_VulkanUtils_getVkInfo(
    ...
    // });
    jclass vkPhysicalDevicesClass = withJniCheck<jclass>(env, [=]() {
        return env->FindClass("com/android/settings/deviceinfo/firmwareversion/VulkanUtils$VkPhysicalDevices");
    });
